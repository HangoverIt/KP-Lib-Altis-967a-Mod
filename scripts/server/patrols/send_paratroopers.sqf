...
{removeBackpack _x; _x addBackPack "B_parachute"; _x assignAsCargo _newvehicle;_x moveInCargo _newvehicle;} forEach (units _para_group); // HangoverIt 18th June 2021 - added assignAsCargo
