...
if (!isNil "used_positions") then {used_positions pushBack _spawn_marker;};
...
[_base_position,opfor_static,true] call KPLIB_fnc_spawnFixedEmplacement;
[_base_position,opfor_static_heavy, true] call KPLIB_fnc_spawnFixedEmplacement;
[_base_position,opfor_static,false] call KPLIB_fnc_spawnFixedEmplacement;
[_base_position,opfor_static, false] call KPLIB_fnc_spawnFixedEmplacement;
[_base_position,opfor_static_heavy, false] call KPLIB_fnc_spawnFixedEmplacement;
...
{_x doFollow (leader _grpsentry)} foreach units _grpsentry;
